  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img class="content-image"
           src="https://fuss10.elemecdn.com/8/40/02872ce8aefe75c16d3190e75ad61jpeg.jpeg" height="100px" width="100px" >
...
<span class="mini-tag">品牌</span>
        ...
        <div class="shop-message">
          <span class="shop-message-detail">{{shop.rating}}&nbsp;&nbsp;&nbsp;</span>
          <span class="shop-message-detail" >月售 {{shop.recent_order_num}} 单&nbsp;&nbsp;&nbsp;</span>
          <span class="shop-message-detail" >{{shop.delivery_mode.text}}<span >约 {{shop.order_lead_time}}&nbsp;&nbsp;&nbsp;</span></span>
          <span class="shop-message-detail" >距离 {{shop.distance}}</span>
        </div>
      </div>
    </div>
